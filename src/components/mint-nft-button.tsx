...
export const MintNFTButton = ({
  setNftSuccessfullyMinted,
}: {
  setNftSuccessfullyMinted: (a: boolean) => void;
}) => {
  ...
  if (isLoadingMint) {
    return (
      <div
        className="flex gap-2 items-center self-center min-h-[52px]"
        role="status"
      >
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Typography className="text-[17px] pt-[0.5px]">
          Mint NFT
        </Typography>{" "}
        {/* Button label */}
      </div>
