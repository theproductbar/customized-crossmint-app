...
import { type EVMSmartWallet, useAuth, useWallet } from "@crossmint/client-sdk-react-ui"; // Auth and Wallet hooks
import { Avatar, AvatarFallback, AvatarImage } from "./avatar"; // Avatar components for user profile picture
import { DropdownMenu, DropdownMenuContent, DropdownMenuTrigger } from "./dropdown-menu"; // Dropdown menu components
        ...
        <DropdownMenuTrigger asChild disabled={walletStatus !== "loaded"}>
            ...
            <div className="flex items-center gap-5 cursor-pointer">
                ...
                <Avatar className="h-9 w-9">
                    <AvatarImage alt="User Avatar" src="" /> {/* Empty source here, can be replaced with actual user image */}
